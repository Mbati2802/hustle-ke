  ...
  return (
    <div className="p-4 lg:p-6 xl:p-8 pb-24 lg:pb-8">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <button onClick={() => openPostJobModal()} className="bg-green-600 hover:bg-green-700 text-white px-4 py-2.5 rounded-xl font-medium text-sm flex items-center gap-2 transition-colors shadow-sm">
